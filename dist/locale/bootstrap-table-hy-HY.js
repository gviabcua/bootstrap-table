	...
	*/
	...
	$$2.fn.bootstrapTable.locales['en-US'] = $$2.fn.bootstrapTable.locales['en'] = {
	  formatCopyRows: function formatCopyRows() {
	    return 'Պատճենել շարքերը';
	  },
	  formatPrint: function formatPrint() {
	    return 'Տպել';
	  },
	  formatLoadingMessage: function formatLoadingMessage() {
	    return 'Բեռնվում է, խնդրում ենք սպասել';
	  },
	  formatRecordsPerPage: function formatRecordsPerPage(pageNumber) {
	    return "".concat(pageNumber, " շարքեր մեկ էջում");
	  },
	  formatShowingRows: function formatShowingRows(pageFrom, pageTo, totalRows, totalNotFiltered) {
	    if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
	      return "Ցուցադրվում է ".concat(pageFrom, " to ").concat(pageTo, " of ").concat(totalRows, " rows (filtered from ").concat(totalNotFiltered, " total rows)");
	    }
	    return "Ցուցադրվում է ".concat(pageFrom, " to ").concat(pageTo, " -ից ").concat(totalRows, " շարքեր");
	  },
	  formatSRPaginationPreText: function formatSRPaginationPreText() {
	    return 'Նախորդ էջ';
	  },
	  formatSRPaginationPageText: function formatSRPaginationPageText(page) {
	    return "դեպի էջ ".concat(page);
	  },
	  formatSRPaginationNextText: function formatSRPaginationNextText() {
	    return 'հաջորդ էջը';
	  },
	  formatDetailPagination: function formatDetailPagination(totalRows) {
	    return "Ցուցադրվում է ".concat(totalRows, " շարքեր");
	  },
	  formatClearSearch: function formatClearSearch() {
	    return 'Մաքրել որոնումը';
	  },
	  formatSearch: function formatSearch() {
	    return 'Որոնում';
	  },
	  formatNoMatches: function formatNoMatches() {
	    return 'Համապատասխան գրառումներ չեն գտնվել';
	  },
	  formatPaginationSwitch: function formatPaginationSwitch() {
	    return 'Թաքցնել/Ցուցադրել էջագրումը';
	  },
	  formatPaginationSwitchDown: function formatPaginationSwitchDown() {
	    return 'Ցույց տալ էջադրումը';
	  },
	  formatPaginationSwitchUp: function formatPaginationSwitchUp() {
	    return 'Թաքցնել էջադրումը';
	  },
	  formatRefresh: function formatRefresh() {
	    return 'Թարմացնել';
	  },
	  formatToggleOn: function formatToggleOn() {
	    return 'Ցույց տալ քարտի տեսքը';
	  },
	  formatToggleOff: function formatToggleOff() {
	    return 'Թաքցնել քարտի տեսքը';
	  },
	  formatColumns: function formatColumns() {
	    return 'Սյունակներ';
	  },
	  formatColumnsToggleAll: function formatColumnsToggleAll() {
	    return 'Միացնել բոլորը';
	  },
	  formatFullscreen: function formatFullscreen() {
	    return 'Ամբողջ էկրանով';
	  },
	  formatAllRows: function formatAllRows() {
	    return 'Բոլորը';
	  },
	  formatAutoRefresh: function formatAutoRefresh() {
	    return 'Ավտոմատ թարմացում';
	  },
	  ...
	  formatFilterControlSwitch: function formatFilterControlSwitch() {
	    return 'Թաքցնել/Ցուցադրել հսկիչները';
	  },
	  formatFilterControlSwitchHide: function formatFilterControlSwitchHide() {
	    return 'Թաքցնել հսկիչները';
	  },
	  formatFilterControlSwitchShow: function formatFilterControlSwitchShow() {
	    return 'Ցույց տալ հսկիչները';
	  }
	};
